...
class getApiPlatform_Graphql_Action_GraphiqlService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['api_platform.graphql.action.graphiql'] = new \ApiPlatform\Core\GraphQl\Action\GraphiQlAction(($container->services['.container.private.twig'] ?? $container->get_Container_Private_TwigService()), ($container->privates['api_platform.router'] ?? $container->getApiPlatform_RouterService()), true, '', NULL);
    }
}
