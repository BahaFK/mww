 ...
 */
class finding extends \App\Entity\finding implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\finding' . "\0" . 'id', '' . "\0" . 'App\\Entity\\finding' . "\0" . 'actions', '' . "\0" . 'App\\Entity\\finding' . "\0" . 'description', '' . "\0" . 'App\\Entity\\finding' . "\0" . 'waste'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (finding $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addAction(\App\Entity\action $action): \App\Entity\finding
    {
     ...
     * {@inheritDoc}
     */
    public function removeAction(\App\Entity\action $action): \App\Entity\finding
    {
     ...
     * {@inheritDoc}
     */
    public function setDescription(string $description): \App\Entity\finding
    {
     ...
     * {@inheritDoc}
     */
    public function setWaste(string $waste): \App\Entity\finding
    {
