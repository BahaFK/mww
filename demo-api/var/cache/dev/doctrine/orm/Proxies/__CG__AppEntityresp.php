 ...
 */
class resp extends \App\Entity\resp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\resp' . "\0" . 'id', '' . "\0" . 'App\\Entity\\resp' . "\0" . 'actions', '' . "\0" . 'App\\Entity\\resp' . "\0" . 'ref', '' . "\0" . 'App\\Entity\\resp' . "\0" . 'name', '' . "\0" . 'App\\Entity\\resp' . "\0" . 'mail'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (resp $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addAction(\App\Entity\action $action): \App\Entity\resp
    {
     ...
     * {@inheritDoc}
     */
    public function removeAction(\App\Entity\action $action): \App\Entity\resp
    {
     ...
     * {@inheritDoc}
     */
    public function setRef(string $ref): \App\Entity\resp
    {
     ...
     * {@inheritDoc}
     */
    public function setName(string $name): \App\Entity\resp
    {
     ...
     * {@inheritDoc}
     */
    public function setMail(string $mail): \App\Entity\resp
    {
