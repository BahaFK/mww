...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\areaCrudController' => 'getAreaCrudControllerService',
            'App\\Controller\\Admin\\findingCrudController' => 'getFindingCrudControllerService',
            'App\\Controller\\Admin\\respCrudController' => 'getRespCrudControllerService',
    ...
    protected function get_Container_Private_SerializerService()
    {
        ...
        $t = ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService());
        ...
        return $this->services['.container.private.serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => $e, 2 => $l, 3 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($m, [], $n), 4 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $n), 5 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\ValidationExceptionNormalizer($this->parameters['api_platform.exception_to_status']), 6 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\HttpExceptionNormalizer(), 7 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\RuntimeExceptionNormalizer(), 8 => $l, 9 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\ErrorNormalizer(), 10 => $e, 11 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($f, $g, $h, $o, NULL, $m, $j, $n), 12 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($f, $p, $m), 13 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($m, true), 14 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 15 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 16 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 17 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($f, $g, $h, $p, $o, $q, $a, $n, $r, [], new RewindableGenerator(function () {
            ...
            return new \EmptyIterator();
        }, 0), $f, $s), 20 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 21 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $n), 23 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 24 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 25 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 26 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 27 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($q, $o, $p), 'page', 'pagination', $f, $a), $f, $o, $i), 28 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 29 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($u, $p, $q), 30 => new \ApiPlatform\Core\GraphQl\Serializer\ObjectNormalizer($u, $p, $k), 31 => $u], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $c, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    {
        return $this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\CrudControllerRegistry'] = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry($this->getEnv('APP_SECRET'), [0 => 'App\\Controller\\Admin\\actionCrudController', 1 => 'App\\Controller\\Admin\\areaCrudController', 2 => 'App\\Controller\\Admin\\findingCrudController', 3 => 'App\\Controller\\Admin\\respCrudController']);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yA8MxOmu3B', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+Wo0vOUzqc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Xj3RnbFXLw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QbvJjITM-p', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bK0berdBiK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entityaction_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entityaction_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityactionApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entityarea_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entityarea_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityareaApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entityfinding_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entityfinding_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityfindingApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entityresp_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entityresp_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityrespApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
        ], [
            'annotated_app_entityaction_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entityarea_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entityfinding_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entityresp_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
        ]);
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('on9avAWWwu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k-Vly4X1fY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
