...
class getImageControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.BE5.yuK'] ?? $container->load('get_ServiceLocator_BE5_YuKService'))->withContext('App\\Controller\\ImageController', $container));
