...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\UnitCrudController' => 'getUnitCrudControllerService',
            'App\\Controller\\Admin\\WasteCrudController' => 'getWasteCrudControllerService',
            'App\\Controller\\ImageController' => 'getImageControllerService',
            'App\\Controller\\ValidateActionController' => 'getValidateActionControllerService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/SwaggerDecorator/SwaggerDecorator.php';
    ...
    protected function get_Container_Private_SerializerService()
    {
        ...
        $l = new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(new \App\Swagger\SwaggerDecorator(new \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer($f, $g, $h, ($this->privates['api_platform.hydra.json_schema.schema_factory'] ?? $this->getApiPlatform_Hydra_JsonSchema_SchemaFactoryService()), ($this->privates['api_platform.json_schema.type_factory'] ?? $this->getApiPlatform_JsonSchema_TypeFactoryService()), ($this->privates['api_platform.operation_path_resolver.router'] ?? $this->getApiPlatform_OperationPathResolver_RouterService()), NULL, $i, NULL, false, 'oauth2', 'application', '', '', [], $this->parameters['api_platform.swagger.api_keys'], $j, true, 'page', false, 'itemsPerPage', $this->parameters['api_platform.formats'], false, 'pagination', [], $this->parameters['api_platform.swagger.versions'], $k, $d)));
        ...
        $u = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($r);
        $v = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($r, $n, $a, $b, $u, NULL, []);
        ...
        return $this->services['.container.private.serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => $e, 2 => $l, 3 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($m, [], $n), 4 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $n), 5 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\ValidationExceptionNormalizer($this->parameters['api_platform.exception_to_status']), 6 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\HttpExceptionNormalizer(), 7 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\RuntimeExceptionNormalizer(), 8 => $l, 9 => new \ApiPlatform\Core\GraphQl\Serializer\Exception\ErrorNormalizer(), 10 => $e, 11 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($f, $g, $h, $o, NULL, $m, $j, $n), 12 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($f, $p, $m), 13 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($m, true), 14 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 15 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 16 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 17 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($f, $g, $h, $p, $o, $q, $a, $n, $r, [], new RewindableGenerator(function () {
            ...
            return new \EmptyIterator();
        }, 0), $f, $s), 20 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 21 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $n), 23 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($r, $n, $b, $u, NULL, [])), 24 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 25 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 26 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 27 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 28 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($q, $o, $p), 'page', 'pagination', $f, $a), $f, $o, $i), 29 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 30 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($v, $p, $q), 31 => new \ApiPlatform\Core\GraphQl\Serializer\ObjectNormalizer($v, $p, $k), 32 => $v], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $c, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\WasteRepository' => ['privates', 'App\\Repository\\WasteRepository', 'getWasteRepositoryService', true],
        ], [
    ...
    {
        return $this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\CrudControllerRegistry'] = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry($this->getEnv('APP_SECRET'), [0 => 'App\\Controller\\Admin\\ActionCrudController', 1 => 'App\\Controller\\Admin\\AreaCrudController', 2 => 'App\\Controller\\Admin\\RespCrudController', 3 => 'App\\Controller\\Admin\\SectionCrudController', 4 => 'App\\Controller\\Admin\\UnitCrudController', 5 => 'App\\Controller\\Admin\\WasteCrudController']);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('84lG4V+sJx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+baO1BI7Nt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('coFBgNrAxU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xDt9kOFsIU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6y3dRcgnQb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_action_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_action_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityActionApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_area_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_area_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityAreaApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_resp_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_resp_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityRespApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
        ], [
            'annotated_app_entity_action_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_area_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_resp_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
        ]);
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('n9QeoLHCSh', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'nelmio_cors.defaults' => [
                'allow_origin' => [
                    0 => 'http://162.19.74.218:4200/action',
                ],
